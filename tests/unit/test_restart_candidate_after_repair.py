...
async def test_restart_all_preserves_isolated_storage(tmp_path):
    ...
    with patch("mesa_qa.runtime.process_manager.MesaCandidateRuntime", return_value=mock_mesa) as mock_runtime_cls, \
         patch("mesa_qa.runtime.process_manager.MesaMCPGatewayProcess", return_value=mock_mcp) as mock_mcp_cls:
